...
impl Settings {
    ...
    pub fn balanced() -> Settings {
        Settings {
            ...
            repel_distance_distr: Uniform::new(0.0, 20.0),
            influence_radius_distr: Uniform::new(20.0, 70.0),
            friction: 0.05,
            flat_force: false,
        }
    }
    ...
    pub fn chaos() -> Settings {
        Settings {
            ...
            repel_distance_distr: Uniform::new(0.0, 30.0),
            influence_radius_distr: Uniform::new(30.0, 100.0),
            friction: 0.01,
            flat_force: false,
        }
    }
    ...
    pub fn diversity() -> Settings {
        Settings {
            ...
            repel_distance_distr: Uniform::new(0.0, 20.0),
            influence_radius_distr: Uniform::new(10.0, 60.0),
            friction: 0.05,
            flat_force: true,
        }
    }
    ...
    pub fn frictionless() -> Settings {
        Settings {
            ...
            repel_distance_distr: Uniform::new(10.0, 10.0),
            influence_radius_distr: Uniform::new(10.0, 60.0),
            friction: 0.0,
            flat_force: true,
        }
    ...
    pub fn gliders() -> Settings {
        Settings {
            ...
            repel_distance_distr: Uniform::new(0.0, 20.0),
            influence_radius_distr: Uniform::new(10.0, 50.0),
            friction: 0.01,
            flat_force: true,
        }
    }
    ...
    pub fn homogeneity() -> Settings {
        Settings {
            ...
            repel_distance_distr: Uniform::new(10.0, 10.0),
            influence_radius_distr: Uniform::new(10.0, 80.0),
            friction: 0.05,
            flat_force: true,
        }
    }
    ...
    pub fn medium_clusters() -> Settings {
        Settings {
            ...
            repel_distance_distr: Uniform::new(0.0, 20.0),
            influence_radius_distr: Uniform::new(20.0, 50.0),
            friction: 0.05,
            flat_force: false,
        }
    }
    ...
    pub fn quiescence() -> Settings {
        Settings {
            ...
            repel_distance_distr: Uniform::new(10.0, 20.0),
            influence_radius_distr: Uniform::new(20.0, 60.0),
            friction: 0.2,
            flat_force: false,
        }
    }
